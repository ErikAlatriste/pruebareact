...
class Signup extends React.Component {
  ...
  handleClick(event) {
    if (event.target.name === "email") {
      this.setState({
        emailClicked: { backgroundColor: "red", color: "white" }
      });
    } else if (event.target.name === "username") {
      this.setState({
        accountClicked: { backgroundColor: "red", color: "white" }
      });
    } else if (event.target.name === "password") {
      this.setState({
        passwordClicked: { backgroundColor: "red", color: "white" }
      });
    } else if (event.target.name === "password_confirmation") {
      this.setState({
        passwordconfirmClicked: { backgroundColor: "red", color: "white" }
      });
    } else if (event.target.name === "phone") {
      this.setState({
        phoneClicked: { backgroundColor: "red", color: "white" }
      });
    ...
    return (
      <div align="center" className="centered-elements">
        ...
        <img
          ...
          src={bio}
          alt="biologo"
          style={{ margin: "auto", height: 256, width: 512 }}
        />
        <Typography>
          ...
          <table className="form-table" style={{ backgroundColor: "white" }}>
            <tbody>
              ...
              <tr className="login-table-tr tr-first" align="center">
                <td
                  className="login-table-td login-table-td-icon td-first"
                  style={this.state.accountClicked}
                >
                ...
                <td className="login-table-td login-table-td-input td-second">
                  <TextField
                    ...
                    className="disable-selection username"
                    variant="outlined"
                    onChange={this.handleChange}
                    onClick={this.handleClick}
                    onBlur={this.handleBlur}
              ...
              <tr className="login-table-tr tr-second" align="center">
                <td
                  className="login-table-td login-table-td-icon td-first"
                  style={this.state.passwordconfirmClicked}
                >
                  <Lock style={{ fontSize: 40 }} />
                </td>
                <td className="login-table-td login-table-td-input td-second">
                  <TextField
                    ...
                    className="disable-selection password_confirmation"
                    variant="outlined"
                    onChange={this.handleChange}
                    onClick={this.handleClick}
                    onBlur={this.handleBlur}
              ...
              <tr className="login-table-tr tr-second" align="center">
                ...
                <td className="login-table-td login-table-td-input td-second">
                  <TextField
                    ...
                    name="phone"
                    label="Telefono"
                    className="disable-selection phone"
                    variant="outlined"
                    onChange={this.handleChange}
                    onClick={this.handleClick}
                    onBlur={this.handleBlur}
              ...
              <tr className="login-table-tr tr-second" align="center">
                ...
                <td className="login-table-td login-table-td-input td-second">
                  <TextField
                    ...
                    name="web"
                    label="Website"
                    className="disable-selection web"
                    variant="outlined"
                    onChange={this.handleChange}
                    onClick={this.handleClick}
                    onBlur={this.handleBlur}
