...
class Mainview extends React.Component {
  constructor(props) {
    super(props);
    this.state = { articles: [], expanded: false, currentPage: 1 };
                ...
                <Card className={classes.card}>
                  ...
                  <CardContent>
                    <Typography component="p">
                      ...
                      <div>
                        <b /> {moment(new Date(data.createdAt)).fromNow()}
                      </div>
                    </Typography>
                  </CardContent>
                  <CardActions className={classes.actions} disableActionSpacing>
                    ...
                    <Button onClick={() => this.handleDelete(data._id)}>
                      Eliminar
                    </Button>
                    <Link to={`/${data.id}/entradas`}>
                      <Button onClick={() => this.handleEdit(data)}>
                        Editar
                      </Button>
                    </Link>
                    <Link to={`/mainview/articulo/${data.id}`}>
                      <Button
                        render={props => (
                          <Leer
                            {...props}
                  ...
                  >
                    <CardContent>
                      <Typography paragraph>Aqui va mas texto</Typography>
                      <Typography paragraph>Y aqui tambien</Typography>
                    </CardContent>
                  </Collapse>
                </Card>
              </Grid>
